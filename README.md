<div align="center">
  ...
  **2022-2026 Batch Student & Aspiring Full-Stack Developer.** <br/>
  Passionate about creating modern, beautiful, and highly performant web applications with a strong focus on **UI/UX architecture** and **clean code standards**.
...
- 🌟 **Design-Driven Development**: I build responsive, glassmorphism-inspired interfaces prioritizing user experience and accessibility.
- ⚡ **Performance First**: Deep focus on Core Web Vitals, optimal asset loading, and React/Next.js rendering optimizations.
- 🛠️ **Clean Architecture**: I write maintainable, highly modular components avoiding prop-drilling and spaghetti code.
